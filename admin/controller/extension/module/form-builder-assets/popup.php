...
<div class="eapps-deactivation-popup">
    <form method="post" id="form-builder-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Constutor de Formulários</div>
        ...
        <div class="eapps-deactivation-popup-callback">
            ...
            <div class="eapps-deactivation-popup-callback-item" id="submitted-callback">
                You have already sent a message. <br><br>If you have not received a response, please Contato by email <a href="mailto:support@elfsight.com">support@elfsight.com</a>
            </div>

            <div class="eapps-deactivation-popup-callback-item" id="error-callback">
                The request failed. Please Contato by email <a href="mailto:support@elfsight.com">support@elfsight.com</a>
            </div>
        </div>
    </form>
