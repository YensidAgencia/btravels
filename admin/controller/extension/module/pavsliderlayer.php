...
class ControllerExtensionModulePavsliderlayer extends Controller {
	...
	public function layer(){
		...
		$this->mdata['transtions'] = array(
			...
			'curtain-1' 		   => 'Certeiro 1',
			'curtain-2' 		   => 'Certeiro 2',
			'curtain-3' 		   => 'Certeiro 3',
			'slideleft' 		   => 'Esquerda',
			'slideright' 		   => 'Direita',
			'slideup' 			   => 'Para cima',
			'slidedown' 		   => 'Para Baixo',
			'papercut' 			   => 'Cortar Página',
			'3dcurtain-horizontal' => '3d Horizontal',
			'3dcurtain-vertical'   => '3d Vertical',
			'flyin'				   => 'Inserir',
			'turnoff' 		       => 'Delisgar',
			'custom-1' 			   => 'Padrão 1',
			'custom-2' 			   => 'Padrão 2',
