...
$_['error_default']     = 'Atenção: O tipo de cliente não pode ser excluído, pois é definido como o tipo de cliente padrão do sistema!';
$_['error_store']       = 'Atenção: O tipo de cliente não pode ser excluído, pois está vinculado a %s Sistema!';
